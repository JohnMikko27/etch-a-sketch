...
//     //maybe have set grid size and then have a create grid size because this kind of does two things, 
//     //it sets a style and creates the grid elements and appends it to grid container
...
//     // element.style.backgroundColor = 'red' (e.g.)
...
// Create code that is organized, has good modules, has good code maintainability, etc!!!!!!!!
// !!!!!
// Make sure variables have descriptive and concise names and same for functions
